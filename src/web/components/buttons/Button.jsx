...
const variants = {
  primary:
    "items-center bg-blue-700 rounded-2xl px-3 py-3 box-border text-white cursor-pointer inline-flex text-base font-semibold justify-center leading-5 min-w-0 overflow-hidden p-0 pl-5 pr-5 text-center select-none align-middle hover:bg-blue-800 text-white active:bg-gray-900",
  styless:
